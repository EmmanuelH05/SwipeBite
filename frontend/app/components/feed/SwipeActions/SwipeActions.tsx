  ...
  return (
    <div className={styles.actions}>
      ...
      <button
        ...
        className={`${styles.btn} ${styles.btnStar}`}
      >
        <svg className={styles.icon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
