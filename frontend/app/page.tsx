              ...
              <div className={styles.cardArea}>
                <CardStack
                  ...
                  swipeCardProps={{
                    ...
                    onPass: () => feed.restaurants[0] && gesture.applySwipeResult(feed.restaurants[0].id, "DISLIKE"),
                    onLike: () => feed.restaurants[0] && gesture.applySwipeResult(feed.restaurants[0].id, "LIKE"),
                    disabled: loading,
